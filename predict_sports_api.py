...
print("="*80)
print("NBA PREDICTIONS - SPORTS API PIPELINE")
print("="*80)

# ============================================================================
# 1. LOAD TRAINED MODELS (same models as original pipeline)
# ============================================================================
...
# ============================================================================
# 2. LOAD DATA -- reads Future_sports_api.csv instead of Future.csv
# ============================================================================
print("\n[2/5] Loading data...")

try:
    df = pd.read_csv('Future_sports_api.csv', on_bad_lines='skip')
except:
    print("  Error: Future_sports_api.csv not found")
    print("  Run combine_sports_api.py first")
    exit()
...
# ============================================================================
# 3. CREATE FEATURES (identical to predict.py)
# ============================================================================
...
# ============================================================================
# 4. MAKE PREDICTIONS (identical to predict.py)
# ============================================================================
...
# Handle ties
tie_mask = np.abs(pred_home - pred_away) < 0.01
tie_indices = np.where(tie_mask)[0]

if len(tie_indices) > 0:
    print(f"  Detected {len(tie_indices)} tie predictions, applying random adjustment...")
...
# ============================================================================
# 5. CREATE RESULTS DATAFRAME (identical schema to predict.py)
# ============================================================================
...
if 'game_identifier' in df.columns:
    ...
    results_df['game_identifier'] = results_df['id'].astype(str)
...
# Grading logic (identical to predict.py)
...
# Reorder columns -- identical to predict.py
final_columns = [
...
# Save -- different output file name
output_file = 'NBA_PREDICTIONS_ML_sports_api.csv'
...
# ============================================================================
print("\n" + "="*80)
print("PREDICTION SUMMARY (Sports API Pipeline)")
print("="*80)
